...
namespace Raven.Abstractions.Util.Buffers
{
    ...
    */
    ...
    /// <summary>
    /// Responsible for building up and accessing a FlatbBuffer formatted byte
    ...
    public class FlatBufferBuilder
    {
        ...
        public void Prep(int size, int additionalBytes = 0)
        {
        ...
        // if needed.
        public void AddBool(bool x) { Prep(sizeof(byte)); PutBool(x); }
        public void AddSbyte(sbyte x) { Prep(sizeof(sbyte)); PutSbyte(x); }
        public void AddByte(byte x) { Prep(sizeof(byte)); PutByte(x); }
        public void AddShort(short x) { Prep(sizeof(short)); PutShort(x); }
        public void AddUshort(ushort x) { Prep(sizeof(ushort)); PutUshort(x); }
        public void AddInt(int x) { Prep(sizeof(int)); PutInt(x); }
        public void AddUint(uint x) { Prep(sizeof(uint)); PutUint(x); }
        public void AddLong(long x) { Prep(sizeof(long)); PutLong(x); }
        public void AddUlong(ulong x) { Prep(sizeof(ulong)); PutUlong(x); }
        public void AddFloat(float x) { Prep(sizeof(float)); PutFloat(x); }
        ...
        {
            Prep(sizeof(int));  // Ensure alignment is already done.
            if (off > Offset)
