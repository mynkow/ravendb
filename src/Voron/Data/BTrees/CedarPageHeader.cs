...
namespace Voron.Data.BTrees
{
    ...
    {        
        ...
        /// </summary>
        public const int MetadataOffset = (Constants.Storage.CedarPageHeaderSize + 16) - (Constants.Storage.CedarPageHeaderSize + 16) % 16;

        /// <summary>
        /// The offset from the start of the <see cref="CedarPageHeader"/> where the tail metadata is stored.
        /// </summary>
        public const int Tail0Offset = CedarPageHeader.MetadataOffset + CedarPageHeader.MaxSupportedBlocks * BlockMetadata.SizeOf;
